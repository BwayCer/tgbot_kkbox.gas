...
assistant.order( 'kkbox/getKmcData', function ( self ) {
    ...
    function handleTgBotMsg(
        ...
        mdCaption = '發行： ' + objSongData.releaseDateInfo.join( '-' ) + '\n'
                  ...
                  + '單曲： '
                    + markDownLinkFilter( objSongData.songName, objSongData.songUrl )
                    + '\n'
                  + '藝人： '
                    + markDownLinkFilter( objSongData.artistName, objSongData.artistUrl )
                    +'\n'
                  + '專輯： '
                    + markDownLinkFilter( objSongData.albumName, objSongData.albumUrl )
        ;
        fhr = tgBotPushJson(
